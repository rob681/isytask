...
export default function SetupPasswordPageWrapper() {
  return (
    <Suspense fallback={
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              No se encontró un token de invitación válido.
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Este enlace de invitación ya no es válido. Contacta al administrador para que te reenvíe la invitación.
            </p>
      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <Card className="w-full max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <h2 className="text-lg font-semibold mb-2">¡Contraseña configurada!</h2>
            <p className="text-sm text-muted-foreground">
              Tu contraseña ha sido configurada exitosamente. Redirigiendo al inicio de sesión...
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="w-full max-w-md relative glass-card shadow-soft">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {setupMutation.isLoading ? "Configurando..." : "Configurar contraseña"}
            </Button>
          </form>
        </CardContent>
      </Card>
